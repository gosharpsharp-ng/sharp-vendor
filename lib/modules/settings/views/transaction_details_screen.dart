...
import 'widgets/transaction_detail_summary_item.dart';
                ...
                children: [
                  SectionBox(children:  [
                    ...
                    TransactionDetailSummaryTypeItem(
                      ...
                      value:  settingsController.selectedTransaction?.type.capitalize??"",
                    ),
                    ...
                    TransactionDetailSummaryItem(
                      title: "Date",
                      value: "${formatDate(settingsController.selectedTransaction!.createdAt)} ${formatTime(settingsController.selectedTransaction!.createdAt)}",
                    ),
                    TransactionDetailSummaryStatusItem(
                      title: "Status",
                      value: settingsController.selectedTransaction!.status.capitalizeFirst??'',
                    ),
                  ]),
