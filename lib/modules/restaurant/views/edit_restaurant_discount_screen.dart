...
class EditRestaurantDiscountScreen extends StatelessWidget {
  const EditRestaurantDiscountScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final DiscountModel discount = Get.arguments as DiscountModel;

    return GetBuilder<RestaurantDiscountController>(
      init: RestaurantDiscountController(),
      initState: (state) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          Get.find<RestaurantDiscountController>().initializeEditForm(discount);
        });
      },
      builder: (controller) {
        return Form(
          ...
          child: Scaffold(
            appBar: defaultAppBar(
              ...
              title: "Edit Restaurant Discount",
            ),
