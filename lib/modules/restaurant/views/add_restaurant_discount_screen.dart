...
class AddRestaurantDiscountScreen extends StatelessWidget {
  const AddRestaurantDiscountScreen({super.key});
    ...
    return GetBuilder<RestaurantDiscountController>(
      ...
      initState: (state) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          Get.find<RestaurantDiscountController>().initializeCreateForm();
        });
      },
      builder: (controller) {
        return Form(
          ...
          child: Scaffold(
            appBar: defaultAppBar(
              ...
              title: "Create Restaurant Discount",
            ),
