...
class EditDiscountScreen extends StatelessWidget {
  const EditDiscountScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final Map<String, dynamic> args = Get.arguments as Map<String, dynamic>;
    final DiscountModel discount = args['discount'] as DiscountModel;
    final int menuId = args['menuId'] as int;

    return GetBuilder<DiscountController>(
      init: DiscountController(),
      initState: (state) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          Get.find<DiscountController>().initializeEditForm(discount);
        });
      },
      builder: (controller) {
        return Form(
